		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
				 ...
				 <tr>
					<td class="ui_text_rt" width="140">建议成本价</td>
					<td class="ui_text_lt">
						<s:textfield name="product.costPrice" cssClass="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt" width="140">建议零售价</td>
					<td class="ui_text_lt">
				 ...
				 <tr>
					...
					<td class="ui_text_lt">
						<s:textarea name="product.intro" cssClass="ui_input_txtarea"></s:textarea>
					</td>
				</tr>
