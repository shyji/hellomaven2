                            ...
                            <s:else>
                                <tr>
                                    <td>
                                        ...
                                        <img alt="点击选择货品" src="/images/common/search.png" class="searchproduct"/>
                                        <s:hidden name="stockOutcomeBill.items.product.id" cssClass="ui_input_txt02" tagName="pid"/>

                                    </td>
                                    <td><span tagName="sn"></span></td>
                                    <td><span tagName="brand"></span></td>
                                    <td><s:textfield name="stockOutcomeBill.items.salePrice" cssClass="ui_input_txt02" tagName="salePrice"/></td>
                                    <td><s:textfield name="stockOutcomeBill.items.number" cssClass="ui_input_txt02" tagName="number"/></td>
                                    <td><span tagName="totalAmount"></span></td>
                                    <td><s:textfield name="stockOutcomeBill.items.remark" cssClass="ui_input_txt02" tagName="remark"/></td>
                                    <td>
                                        <a href="javascript:void(0);" class="removeItem">删除明细</a>
                                    </td>
                                </tr>
                                       ...
                                       var i = 0;
                                        $("#edit_table_body tr").each(function(index,row){
                                            ...
                                            if(!_row.find("[tagName=pid]").val() || !_row.find("[tagName=salePrice]").val() || !_row.find("[tagName=number]")){
                                                ...
                                                _row.find("[tagName=pid]").prop("name","stockOutcomeBill.items["+i+"].product.id");
                                                _row.find("[tagName=salePrice]").prop("name","stockOutcomeBill.items["+i+"].salePrice");
                                                _row.find("[tagName=number]").prop("name","stockOutcomeBill.items["+i+"].number");
                                                _row.find("[tagName=remark]").prop("name","stockOutcomeBill.items["+i+"].remark");
                                                i++;
                                            }
                                        });
