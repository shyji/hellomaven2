            ...
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_center">
                        ...
                        状态
                        <s:select name="qo.status" list="#{0:'正常',1:'已审核'}" headerKey="-1" headerValue="--全部--"
                                  cssClass="ui_select01"/>
                    </div>
                    <div id="box_bottom">
                        <input type="button" value="查询" class="ui_input_btn01 btn_page" data-page="1"/>
                        <input type="button" value="批量删除" class="ui_input_btn01 btn_batchDelete"
                               data-url="<s:url action="orderBill_batchDelete"/>"/>
                        <input type="button" value="新增" class="ui_input_btn01 btn_input"
                               data-url="<s:url action="orderBill_input"/>"/>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <s:iterator value="#pageResult.listData">
                        <tr>
                            ...
                            <td>
                                <s:a action="orderBill_input">
                                    <s:param name="orderBill.id" value="id"/>
                                    编辑
                                </s:a>
                                <a href="javascript:;" class="btn_delete"
                                   data-url="<s:url action="orderBill_delete">
                                <s:param name="orderBill.id" value="id"/>
                                </s:url>">删除</a>
                                <s:if test="status==0">
                                    <s:a action="orderBill_audit"><s:param name="orderBill.id" value="id"/>审核</s:a>
                                </s:if>
                                <s:else>
                                    <s:a action="orderBill_view"><s:param name="orderBill.id" value="id"/>查看</s:a>
                                </s:else>
                            </td>
                        </tr>
                    </s:iterator>
