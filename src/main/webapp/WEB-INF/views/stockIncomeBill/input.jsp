            ...
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <s:textfield name="stockIncomeBill.vdate" cssClass="Wdate ui_input_txt02" value="%{#_vdate}" onclick="WdatePicker();"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:select list="#suppliers" name="stockIncomeBill.supplier.id" listKey="id" listValue="name"/>
                    </td>
                </tr>
                <tr>
                ...
                <%--<tr>--%>
                    ...
                    <%--<td class="ui_text_lt">--%>
                        <%--<s:textfield name="stockIncomeBill.totalNum" cssClass="ui_input_txt02"/>--%>
                    <%--</td>--%>
                <%--</tr>--%>
                <%--<tr>--%>
                    <%--<td class="ui_text_rt" width="140">总计</td>--%>
                    <%--<td class="ui_text_lt">--%>
                        <%--<s:textfield name="stockIncomeBill.totalAmount" cssClass="ui_input_txt02"/>--%>
                    <%--</td>--%>
                </tr>
                                ...
                                <s:iterator value="stockIncomeBill.items">
                                    <tr>
                                        <td>
                                            ...
                                            <s:hidden name="stockIncomeBill.items.product.id" cssClass="ui_input_txt02" tagName="pid" value="%{product.id}"/>
                                        </td>
                                        <td><span tagName="sn"><s:property value="product.sn"/></span></td>
                                        <td><span tagName="brand"><s:property value="product.brand.name"/></span></td>
                                        <td><s:textfield name="stockIncomeBill.items.salePrice" cssClass="ui_input_txt02" tagName="salePrice" value="%{salePrice}"/></td>
                                        <td><s:textfield name="stockIncomeBill.items.number" cssClass="ui_input_txt02" tagName="number" value="%{number}"/></td>
                                        <td><span tagName="totalAmount"><s:property value="totalAmount"/></span></td>
                                        <td><s:textfield name="stockIncomeBill.items.remark" cssClass="ui_input_txt02" tagName="remark" value="%{remark}"/></td>
                                        <td>
                            ...
                            <s:else>
                                <tr>
                                    <td>
                                        ...
                                        <img alt="点击选择货品" src="/images/common/search.png" class="searchproduct"/>
                                        <s:hidden name="stockIncomeBill.items.product.id" cssClass="ui_input_txt02" tagName="pid"/>

                                    </td>
                                    <td><span tagName="sn"></span></td>
                                    <td><span tagName="brand"></span></td>
                                    <td><s:textfield name="stockIncomeBill.items.salePrice" cssClass="ui_input_txt02" tagName="salePrice"/></td>
                                    <td><s:textfield name="stockIncomeBill.items.number" cssClass="ui_input_txt02" tagName="number"/></td>
                                    <td><span tagName="totalAmount"></span></td>
                                    <td><s:textfield name="stockIncomeBill.items.remark" cssClass="ui_input_txt02" tagName="remark"/></td>
                                    <td>
                                        <a href="javascript:void(0);" class="removeItem">删除明细</a>
                                    </td>
                                </tr>
                                       ...
                                       var i = 0;
                                        $("#edit_table_body tr").each(function(index,row){
                                            ...
                                            if(!_row.find("[tagName=pid]").val() || !_row.find("[tagName=salePrice]").val() || !_row.find("[tagName=number]")){
                                                ...
                                                _row.find("[tagName=pid]").prop("name","stockIncomeBill.items["+i+"].product.id");
                                                _row.find("[tagName=salePrice]").prop("name","stockIncomeBill.items["+i+"].salePrice");
                                                _row.find("[tagName=number]").prop("name","stockIncomeBill.items["+i+"].number");
                                                _row.find("[tagName=remark]").prop("name","stockIncomeBill.items["+i+"].remark");
                                                i++;
                                            }
                                        });
