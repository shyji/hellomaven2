            ...
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_center">
                        ...
                        供应商
                        <s:select list="#suppliers" name="qo.supplierId" listKey="id" listValue="name" headerKey="-1" headerValue="--全部--" cssClass="ui_select01"/>
                        仓库
                        <s:select list="#depots" name="qo.depotId" listKey="id" listValue="name" headerKey="-1" headerValue="--全部--" cssClass="ui_select01"/>
                        状态
                    ...
                    <div id="box_bottom">
                        ...
                        <input type="button" value="批量删除" class="ui_input_btn01 btn_batchDelete"
                               data-url="<s:url action="stockIncomeBill_batchDelete"/>"/>
                        <input type="button" value="新增" class="ui_input_btn01 btn_input"
                               data-url="<s:url action="stockIncomeBill_input"/>"/>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <s:iterator value="#pageResult.listData">
                        <tr>
                            ...
                            <td>
                                <s:a action="stockIncomeBill_input">
                                    <s:param name="stockIncomeBill.id" value="id"/>
                                    编辑
                                </s:a>
                                <a href="javascript:;" class="btn_delete"
                                   data-url="<s:url action="stockIncomeBill_delete">
                                <s:param name="stockIncomeBill.id" value="id"/>
                                </s:url>">删除</a>
                                <s:if test="status==0">
                                <s:a action="stockIncomeBill_audit"><s:param name="stockIncomeBill.id" value="id"/>审核</s:a>
                                </s:if>
                                <s:else>
                                    <s:a action="stockIncomeBill_view"><s:param name="stockIncomeBill.id" value="id"/>查看</s:a>
                                </s:else>
                            </td>
                        </tr>
                    </s:iterator>
